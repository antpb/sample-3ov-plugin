...
const targetDirectory = path.join(__dirname, 'plugin-build', isPro ? 'pro/xr-chess-block' : 'free/xr-chess-block');
...
const zipFileName = isPro ? 'xr-chess-block-pro.zip' : 'xr-chess-block.zip';
