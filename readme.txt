...
A WordPress plugin extending the 3OV core plugin adding a "Three Custom Block" that demonstrates a mirror in Three.js fully compatible with the Block Editor view.

== Description ==
A simple custom three.js example built on top of 3OV
